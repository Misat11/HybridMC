...
@Getter
public class ServerDeclareRecipesPacket404 extends MinecraftPacket implements ServerDeclareRecipesPacket {
    private byte[] data;

    @SuppressWarnings("unused")
    private ServerDeclareRecipesPacket404() {
    }

    @Deprecated // This packet isn't fully implemented, please send a PR if you need to use it
    public ServerDeclareRecipesPacket404(byte[] data) {
        this.data = data;
    }
