...
@Getter
public class ClientSetBeaconEffectPacket404 extends MinecraftPacket implements ClientSetBeaconEffectPacket {
    private int primaryEffect;
    private int secondaryEffect;

    @SuppressWarnings("unused")
    private ClientSetBeaconEffectPacket404() {
    }

    public ClientSetBeaconEffectPacket404(int primaryEffect, int secondaryEffect) {
