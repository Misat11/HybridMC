...
@Getter
public class ServerScoreboardObjectivePacket401 extends MinecraftPacket implements ServerScoreboardObjectivePacket {
    private String name;
    ...
    private ServerScoreboardObjectivePacket401() {
    }

    public ServerScoreboardObjectivePacket401(String name) {
        this.name = name;
        this.action = ObjectiveAction.REMOVE;
    }

    public ServerScoreboardObjectivePacket401(String name, ObjectiveAction action, Message displayName, ScoreType type) {
