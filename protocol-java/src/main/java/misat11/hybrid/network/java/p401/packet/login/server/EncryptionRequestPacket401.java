...
@Getter
public class EncryptionRequestPacket401 extends MinecraftPacket implements EncryptionRequestPacket {
    private String serverId;
    private PublicKey publicKey;
    private byte verifyToken[];

    @SuppressWarnings("unused")
    private EncryptionRequestPacket401() {
    }

    public EncryptionRequestPacket401(String serverId, PublicKey publicKey, byte verifyToken[]) {
