...
@Getter
public class ServerDisplayScoreboardPacket404 extends MinecraftPacket implements ServerDisplayScoreboardPacket {
    private ScoreboardPosition position;
    private String scoreboardName;

    @SuppressWarnings("unused")
    private ServerDisplayScoreboardPacket404() {
    }

    public ServerDisplayScoreboardPacket404(ScoreboardPosition position, String name) {
