...
@Getter
public class ClientSteerVehiclePacket393 extends MinecraftPacket implements ClientSteerVehiclePacket {
    ...
    private ClientSteerVehiclePacket393() {
    }

    public ClientSteerVehiclePacket393(float sideways, float forward, boolean jump, boolean dismount) {
