...
public class ServerWindowPropertyPacket401 extends MinecraftPacket implements ServerWindowPropertyPacket {
    private int windowId;
    private int property;
    private int value;

    @SuppressWarnings("unused")
    private ServerWindowPropertyPacket401() {
    }

    public ServerWindowPropertyPacket401(int windowId, int property, int value) {
        this.windowId = windowId;
        this.property = property;
        this.value = value;
    }

    public <T extends Enum<T> & WindowProperty> ServerWindowPropertyPacket401(int windowId, T property, int value) {
        this.windowId = windowId;
