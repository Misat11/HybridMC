...
@Getter
public class ClientSettingsPacket401 extends MinecraftPacket implements ClientSettingsPacket {
    ...
    private ClientSettingsPacket401() {
    }

    public ClientSettingsPacket401(String locale, int renderDistance, ChatVisibility chatVisibility, boolean usedChatColors, SkinPart[] visibleParts, Hand mainHand) {
        this.locale = locale;
