...
@Getter
public class ServerEntityMetadataPacket401 extends MinecraftPacket implements ServerEntityMetadataPacket {
    private int entityId;
    private EntityMetadata metadata[];

    @SuppressWarnings("unused")
    private ServerEntityMetadataPacket401() {
    }

    public ServerEntityMetadataPacket401(int entityId, EntityMetadata metadata[]) {
