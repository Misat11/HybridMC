...
@Getter
public class ClientSteerBoatPacket393 extends MinecraftPacket implements ClientSteerBoatPacket {
    private boolean rightPaddleTurning;
    private boolean leftPaddleTurning;

    @SuppressWarnings("unused")
    private ClientSteerBoatPacket393() {
    }

    public ClientSteerBoatPacket393(boolean rightPaddleTurning, boolean leftPaddleTurning) {
