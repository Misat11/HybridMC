...
@Getter
public class ServerWorldBorderPacket393 extends MinecraftPacket implements ServerWorldBorderPacket {
    ...
    private ServerWorldBorderPacket393() {
    }

    public ServerWorldBorderPacket393(double radius) {
        this.action = WorldBorderAction.SET_SIZE;
        this.radius = radius;
    }

    public ServerWorldBorderPacket393(double oldRadius, double newRadius, long speed) {
    ...
    public ServerWorldBorderPacket393(double centerX, double centerY) {
        this.action = WorldBorderAction.SET_CENTER;
        this.centerX = centerX;
        this.centerY = centerY;
    }

    public ServerWorldBorderPacket393(double centerX, double centerY, double oldRadius, double newRadius, long speed, int portalTeleportBoundary, int warningTime, int warningBlocks) {
    ...
    public ServerWorldBorderPacket393(int warning, boolean time) {
        if(time) {
