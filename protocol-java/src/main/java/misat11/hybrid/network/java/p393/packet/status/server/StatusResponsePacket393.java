...
@Getter
public class StatusResponsePacket393 extends MinecraftPacket implements StatusResponsePacket {
    private ServerStatusInfo info;

    @SuppressWarnings("unused")
    private StatusResponsePacket393() {
    }

    public StatusResponsePacket393(ServerStatusInfo info) {
        this.info = info;
    }
