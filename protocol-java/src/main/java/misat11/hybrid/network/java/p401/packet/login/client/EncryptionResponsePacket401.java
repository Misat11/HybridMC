...
public class EncryptionResponsePacket401 extends MinecraftPacket implements EncryptionResponsePacket {
    private byte sharedKey[];
    private byte verifyToken[];

    @SuppressWarnings("unused")
    private EncryptionResponsePacket401() {
    }

    public EncryptionResponsePacket401(SecretKey secretKey, PublicKey publicKey, byte verifyToken[]) {
