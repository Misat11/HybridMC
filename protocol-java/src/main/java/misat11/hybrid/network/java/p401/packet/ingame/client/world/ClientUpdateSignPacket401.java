...
@Getter
public class ClientUpdateSignPacket401 extends MinecraftPacket implements ClientUpdateSignPacket {
    private Position position;
    private String lines[];

    @SuppressWarnings("unused")
    private ClientUpdateSignPacket401() {
    }

    public ClientUpdateSignPacket401(Position position, String lines[]) {
        if(lines.length != 4) {
