...
public class ClientCraftingBookDataPacket404 extends MinecraftPacket implements ClientCraftingBookDataPacket {
    ...
    private ClientCraftingBookDataPacket404() {
    }

    public ClientCraftingBookDataPacket404(String recipeId) {
        this.type = CraftingBookDataType.DISPLAYED_RECIPE;
        this.recipeId = recipeId;
    }

    public ClientCraftingBookDataPacket404(boolean craftingBookOpen, boolean filterCraftingActive,
