...
@Getter
public class ClientUpdateSignPacket404 extends MinecraftPacket implements ClientUpdateSignPacket {
    private Position position;
    private String lines[];

    @SuppressWarnings("unused")
    private ClientUpdateSignPacket404() {
    }

    public ClientUpdateSignPacket404(Position position, String lines[]) {
        if(lines.length != 4) {
