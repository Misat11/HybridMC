package misat11.hybrid.network.java.p401.packet.handshake.client;
...
@Getter
public class HandshakePacket401 extends MinecraftPacket implements HandshakePacket {
    ...
    private HandshakePacket401() {
    }

    public HandshakePacket401(int protocolVersion, String hostName, int port, HandshakeIntent intent) {
