package misat11.hybrid.network.java.p393.packet.handshake.client;
...
@Getter
public class HandshakePacket393 extends MinecraftPacket implements HandshakePacket {
    ...
    private HandshakePacket393() {
    }

    public HandshakePacket393(int protocolVersion, String hostName, int port, HandshakeIntent intent) {
