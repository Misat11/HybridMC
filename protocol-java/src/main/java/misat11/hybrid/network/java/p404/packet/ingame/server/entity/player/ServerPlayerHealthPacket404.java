...
@Getter
public class ServerPlayerHealthPacket404 extends MinecraftPacket implements ServerPlayerHealthPacket {
    private float health;
    private int food;
    private float saturation;

    @SuppressWarnings("unused")
    private ServerPlayerHealthPacket404() {
    }

    public ServerPlayerHealthPacket404(float health, int food, float saturation) {
        this.health = health;
        this.food = food;
