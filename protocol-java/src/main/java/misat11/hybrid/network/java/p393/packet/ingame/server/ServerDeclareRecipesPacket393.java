...
@Getter
public class ServerDeclareRecipesPacket393 extends MinecraftPacket implements ServerDeclareRecipesPacket {
    private byte[] data;

    @SuppressWarnings("unused")
    private ServerDeclareRecipesPacket393() {
    }

    @Deprecated // This packet isn't fully implemented, please send a PR if you need to use it
    public ServerDeclareRecipesPacket393(byte[] data) {
        this.data = data;
    }
