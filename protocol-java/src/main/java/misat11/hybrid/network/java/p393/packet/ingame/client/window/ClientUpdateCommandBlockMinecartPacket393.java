...
@Getter
public class ClientUpdateCommandBlockMinecartPacket393 extends MinecraftPacket implements ClientUpdateCommandBlockMinecartPacket {
    private int entityId;
    private String command;
    private boolean doesTrackOutput;

    @SuppressWarnings("unused")
    private ClientUpdateCommandBlockMinecartPacket393() {
    }

    public ClientUpdateCommandBlockMinecartPacket393(int entityId, String command, boolean doesTrackOutput) {
