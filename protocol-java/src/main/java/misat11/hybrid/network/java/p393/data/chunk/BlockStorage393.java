package misat11.hybrid.network.java.p393.data.chunk;
...
public class BlockStorage393 extends BlockStorage {
	
	public BlockStorage393() {
		super();
	}

    public BlockStorage393(NetInput in, NetUtil util) throws IOException {
    	super(in, util);
    }
