...
@Getter
public class ClientUpdateCommandBlockPacket401 extends MinecraftPacket implements ClientUpdateCommandBlockPacket {
    ...
    private ClientUpdateCommandBlockPacket401() {
    }

    public ClientUpdateCommandBlockPacket401(Position position, String command, CommandBlockMode mode,
