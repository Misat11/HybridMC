...
@Getter
public class ClientPlayerMovementPacket393 extends MinecraftPacket implements ClientPlayerMovementPacket {
    protected double x;
    protected double y;
    protected double z;
    protected float yaw;
    ...
    protected ClientPlayerMovementPacket393() {
    }

    public ClientPlayerMovementPacket393(boolean onGround) {
