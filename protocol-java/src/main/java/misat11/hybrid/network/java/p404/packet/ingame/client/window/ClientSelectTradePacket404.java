...
@Getter
public class ClientSelectTradePacket404 extends MinecraftPacket implements ClientSelectTradePacket {
    private int slot;

    @SuppressWarnings("unused")
    private ClientSelectTradePacket404() {
    }

    public ClientSelectTradePacket404(int slot) {
        this.slot = slot;
    }
