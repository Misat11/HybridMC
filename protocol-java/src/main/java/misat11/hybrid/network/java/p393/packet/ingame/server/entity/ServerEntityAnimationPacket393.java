...
@Getter
public class ServerEntityAnimationPacket393 extends MinecraftPacket implements ServerEntityAnimationPacket {
    private int entityId;
    private Animation animation;

    @SuppressWarnings("unused")
    private ServerEntityAnimationPacket393() {
    }

    public ServerEntityAnimationPacket393(int entityId, Animation animation) {
