...
@Getter
public class ClientSettingsPacket404 extends MinecraftPacket implements ClientSettingsPacket {
    ...
    private ClientSettingsPacket404() {
    }

    public ClientSettingsPacket404(String locale, int renderDistance, ChatVisibility chatVisibility, boolean usedChatColors, SkinPart[] visibleParts, Hand mainHand) {
        this.locale = locale;
