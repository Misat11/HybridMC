...
@Getter
public class ServerOpenWindowPacket393 extends MinecraftPacket implements ServerOpenWindowPacket {
    ...
    private ServerOpenWindowPacket393() {
    }

    public ServerOpenWindowPacket393(int windowId, WindowType type, String name, int slots) {
        this(windowId, type, name, slots, 0);
    }

    public ServerOpenWindowPacket393(int windowId, WindowType type, String name, int slots, int ownerEntityId) {
