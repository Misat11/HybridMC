...
@Getter
public class ServerPlayerPositionRotationPacket401 extends MinecraftPacket implements ServerPlayerPositionRotationPacket {
    private double x;
    private double y;
    private double z;
    private float yaw;
    ...
    private ServerPlayerPositionRotationPacket401() {
    }

    public ServerPlayerPositionRotationPacket401(double x, double y, double z, float yaw, float pitch, int teleportId, PositionElement... relative) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.yaw = yaw;
