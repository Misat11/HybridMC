...
@Getter
public class ServerPlayerFacingPacket404 extends MinecraftPacket implements ServerPlayerFacingPacket {
    ...
    private ServerPlayerFacingPacket404() {
    }

    public ServerPlayerFacingPacket404(FeetOrEyes origin, double x, double y, double z) {
        this.origin = origin;
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public ServerPlayerFacingPacket404(FeetOrEyes origin, int targetEntityId, FeetOrEyes lookAt) {
        this.origin = origin;
