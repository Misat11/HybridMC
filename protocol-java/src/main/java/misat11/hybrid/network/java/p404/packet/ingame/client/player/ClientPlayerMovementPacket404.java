...
@Getter
public class ClientPlayerMovementPacket404 extends MinecraftPacket implements ClientPlayerMovementPacket {
    protected double x;
    protected double y;
    protected double z;
    protected float yaw;
    ...
    protected ClientPlayerMovementPacket404() {
    }

    public ClientPlayerMovementPacket404(boolean onGround) {
