...
@Getter
public class ServerStatisticsPacket401 extends MinecraftPacket implements ServerStatisticsPacket {
    private Map<Statistic, Integer> statistics = new HashMap<Statistic, Integer>();

    @SuppressWarnings("unused")
    private ServerStatisticsPacket401() {
    }

    public ServerStatisticsPacket401(Map<Statistic, Integer> statistics) {
