...
@Getter
public class ServerEntityAnimationPacket401 extends MinecraftPacket implements ServerEntityAnimationPacket {
    private int entityId;
    private Animation animation;

    @SuppressWarnings("unused")
    private ServerEntityAnimationPacket401() {
    }

    public ServerEntityAnimationPacket401(int entityId, Animation animation) {
