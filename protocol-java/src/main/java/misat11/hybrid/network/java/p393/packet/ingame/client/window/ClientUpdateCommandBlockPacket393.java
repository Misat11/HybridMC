...
@Getter
public class ClientUpdateCommandBlockPacket393 extends MinecraftPacket implements ClientUpdateCommandBlockPacket {
    ...
    private ClientUpdateCommandBlockPacket393() {
    }

    public ClientUpdateCommandBlockPacket393(Position position, String command, CommandBlockMode mode,
