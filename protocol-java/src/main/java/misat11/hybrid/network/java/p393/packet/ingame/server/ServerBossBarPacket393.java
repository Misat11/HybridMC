...
@Getter
public class ServerBossBarPacket393 extends MinecraftPacket implements ServerBossBarPacket {
    private UUID UUID;
    ...
    private ServerBossBarPacket393() {
    }

    public ServerBossBarPacket393(UUID uuid, BossBarAction action, Message title, float health, BossBarColor color, BossBarDivision division, boolean darkenSky, boolean playEndMusic, boolean showFog) {
        this.UUID = uuid;
    ...
    public ServerBossBarPacket393(UUID uuid) {
        this.UUID = uuid;
        this.action = BossBarAction.REMOVE;
    }

    public ServerBossBarPacket393(UUID uuid, BossBarAction action, float health) {
        this.UUID = uuid;
    ...
    public ServerBossBarPacket393(UUID uuid, BossBarAction action, Message title) {
        this.UUID = uuid;
    ...
    public ServerBossBarPacket393(UUID uuid, BossBarAction action, BossBarColor color, BossBarDivision division) {
        this.UUID = uuid;
    ...
    public ServerBossBarPacket393(UUID uuid, BossBarAction action, boolean darkenSky, boolean playEndMusic, boolean showFog) {
        this.UUID = uuid;
    ...
    public void read(NetInput in) throws IOException {
        ...
        if(this.action == BossBarAction.ADD || this.action == BossBarAction.UPDATE_FLAGS) {
            ...
            this.showFog = this.playEndMusic = (flags & 0x2) == 0x2;
        }
    }
    ...
    public void write(NetOutput out) throws IOException {
        ...
        if(this.action == BossBarAction.ADD || this.action == BossBarAction.UPDATE_FLAGS) {
            ...
            if(this.playEndMusic || this.showFog) {
                flags |= 0x2;
            }
