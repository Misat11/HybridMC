...
@Getter
public class ClientPrepareCraftingGridPacket401 extends MinecraftPacket implements ClientPrepareCraftingGridPacket {
    private int windowId;
    private String recipeId;
    private boolean makeAll;

    @SuppressWarnings("unused")
    private ClientPrepareCraftingGridPacket401() {
    }

    public ClientPrepareCraftingGridPacket401(int windowId, String recipeId, boolean makeAll) {
