...
@Getter
public class ServerWorldBorderPacket401 extends MinecraftPacket implements ServerWorldBorderPacket {
    ...
    private ServerWorldBorderPacket401() {
    }

    public ServerWorldBorderPacket401(double radius) {
        this.action = WorldBorderAction.SET_SIZE;
        this.radius = radius;
    }

    public ServerWorldBorderPacket401(double oldRadius, double newRadius, long speed) {
    ...
    public ServerWorldBorderPacket401(double centerX, double centerY) {
        this.action = WorldBorderAction.SET_CENTER;
        this.centerX = centerX;
        this.centerY = centerY;
    }

    public ServerWorldBorderPacket401(double centerX, double centerY, double oldRadius, double newRadius, long speed, int portalTeleportBoundary, int warningTime, int warningBlocks) {
    ...
    public ServerWorldBorderPacket401(int warning, boolean time) {
        if(time) {
