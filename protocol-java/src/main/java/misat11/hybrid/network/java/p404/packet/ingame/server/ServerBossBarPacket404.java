...
@Getter
public class ServerBossBarPacket404 extends MinecraftPacket implements ServerBossBarPacket {
    private UUID UUID;
    ...
    private ServerBossBarPacket404() {
    }

    public ServerBossBarPacket404(UUID uuid, BossBarAction action, Message title, float health, BossBarColor color, BossBarDivision division, boolean darkenSky, boolean playEndMusic, boolean showFog) {
        this.UUID = uuid;
    ...
    public ServerBossBarPacket404(UUID uuid) {
        this.UUID = uuid;
        this.action = BossBarAction.REMOVE;
    }

    public ServerBossBarPacket404(UUID uuid, BossBarAction action, float health) {
        this.UUID = uuid;
    ...
    public ServerBossBarPacket404(UUID uuid, BossBarAction action, Message title) {
        this.UUID = uuid;
    ...
    public ServerBossBarPacket404(UUID uuid, BossBarAction action, BossBarColor color, BossBarDivision division) {
        this.UUID = uuid;
    ...
    public ServerBossBarPacket404(UUID uuid, BossBarAction action, boolean darkenSky, boolean playEndMusic, boolean showFog) {
        this.UUID = uuid;
