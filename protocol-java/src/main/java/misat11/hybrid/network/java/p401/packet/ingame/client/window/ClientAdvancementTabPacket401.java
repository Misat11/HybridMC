...
public class ClientAdvancementTabPacket401 extends MinecraftPacket implements ClientAdvancementTabPacket {
    private AdvancementTabAction action;
    private String tabId;

    public ClientAdvancementTabPacket401() {
        this.action = AdvancementTabAction.CLOSED_SCREEN;
    }

    public ClientAdvancementTabPacket401(String tabId) {
