...
@Getter
public class ServerTeamPacket393 extends MinecraftPacket implements ServerTeamPacket {
    ...
    private ServerTeamPacket393() {
    }

    public ServerTeamPacket393(String name) {
        this.teamName = name;
        this.action = TeamAction.REMOVE;
    }

    public ServerTeamPacket393(String name, TeamAction action, String players[]) {
    ...
    public ServerTeamPacket393(String name, Message displayName, Message prefix, Message suffix, boolean friendlyFire, boolean seeFriendlyInvisibles, NameTagVisibility nameTagVisibility, CollisionRule collisionRule, TeamColor color) {
        this.teamName = name;
    ...
    public ServerTeamPacket393(String name, Message displayName, Message prefix, Message suffix, boolean friendlyFire, boolean seeFriendlyInvisibles, NameTagVisibility nameTagVisibility, CollisionRule collisionRule, TeamColor color, String players[]) {
        this.teamName = name;
        this.displayName = displayName;
        this.prefix = prefix;
        this.suffix = suffix;
