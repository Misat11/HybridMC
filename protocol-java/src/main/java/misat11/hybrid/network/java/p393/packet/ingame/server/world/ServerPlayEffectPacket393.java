...
@Getter
public class ServerPlayEffectPacket393 extends MinecraftPacket implements ServerPlayEffectPacket {
    ...
    private ServerPlayEffectPacket393() {
    }

    public ServerPlayEffectPacket393(WorldEffect effect, Position position, WorldEffectData data) {
        this(effect, position, data, false);
    }

    public ServerPlayEffectPacket393(WorldEffect effect, Position position, WorldEffectData data, boolean broadcast) {
        this.effect = effect;
