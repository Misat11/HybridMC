...
@Getter
public class ServerSpawnPaintingPacket393 extends MinecraftPacket implements ServerSpawnPaintingPacket {
    ...
    private ServerSpawnPaintingPacket393() {
    }

    public ServerSpawnPaintingPacket393(int entityId, UUID uuid, PaintingType paintingType, Position position, HangingDirection direction) {
