...
@Getter
public class ServerMapDataPacket393 extends MinecraftPacket implements ServerMapDataPacket {
    private int mapId;
    private byte scale;
    ...
    private ServerMapDataPacket393() {
    }

    public ServerMapDataPacket393(int mapId, byte scale, boolean trackingPosition, MapIcon icons[]) {
        this(mapId, scale, trackingPosition, icons, null);
    }

    public ServerMapDataPacket393(int mapId, byte scale, boolean trackingPosition, MapIcon icons[], MapData data) {
        this.mapId = mapId;
        this.scale = scale;
