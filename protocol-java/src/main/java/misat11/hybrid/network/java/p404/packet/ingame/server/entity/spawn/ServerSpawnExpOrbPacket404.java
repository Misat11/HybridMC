...
@Getter
public class ServerSpawnExpOrbPacket404 extends MinecraftPacket implements ServerSpawnExpOrbPacket {
    ...
    private ServerSpawnExpOrbPacket404() {
    }

    public ServerSpawnExpOrbPacket404(int entityId, double x, double y, double z, int exp) {
