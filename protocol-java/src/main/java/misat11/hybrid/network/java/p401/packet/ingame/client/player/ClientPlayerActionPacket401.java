...
@Getter
public class ClientPlayerActionPacket401 extends MinecraftPacket implements ClientPlayerActionPacket {
    private PlayerAction action;
    private Position position;
    private BlockFace face;

    @SuppressWarnings("unused")
    private ClientPlayerActionPacket401() {
    }

    public ClientPlayerActionPacket401(PlayerAction action, Position position, BlockFace face) {
        this.action = action;
