...
@Getter
public class ServerPlayerListEntryPacket393 extends MinecraftPacket implements ServerPlayerListEntryPacket {
    private PlayerListEntryAction action;
    private PlayerListEntry entries[];

    @SuppressWarnings("unused")
    private ServerPlayerListEntryPacket393() {
    }

    public ServerPlayerListEntryPacket393(PlayerListEntryAction action, PlayerListEntry entries[]) {
        this.action = action;
