...
public class ServerWindowPropertyPacket404 extends MinecraftPacket implements ServerWindowPropertyPacket {
    private int windowId;
    private int property;
    private int value;

    @SuppressWarnings("unused")
    private ServerWindowPropertyPacket404() {
    }

    public ServerWindowPropertyPacket404(int windowId, int property, int value) {
        this.windowId = windowId;
        this.property = property;
        this.value = value;
    }

    public <T extends Enum<T> & WindowProperty> ServerWindowPropertyPacket404(int windowId, T property, int value) {
        this.windowId = windowId;
