...
@Getter
public class ServerEntityHeadLookPacket401 extends MinecraftPacket implements ServerEntityHeadLookPacket {
    private int entityId;
    private float headYaw;

    @SuppressWarnings("unused")
    private ServerEntityHeadLookPacket401() {
    }

    public ServerEntityHeadLookPacket401(int entityId, float headYaw) {
