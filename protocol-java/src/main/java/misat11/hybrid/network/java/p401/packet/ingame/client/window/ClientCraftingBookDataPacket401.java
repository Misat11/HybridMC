...
public class ClientCraftingBookDataPacket401 extends MinecraftPacket implements ClientCraftingBookDataPacket {
    ...
    private ClientCraftingBookDataPacket401() {
    }

    public ClientCraftingBookDataPacket401(String recipeId) {
        this.type = CraftingBookDataType.DISPLAYED_RECIPE;
        this.recipeId = recipeId;
    }

    public ClientCraftingBookDataPacket401(boolean craftingBookOpen, boolean filterCraftingActive,
