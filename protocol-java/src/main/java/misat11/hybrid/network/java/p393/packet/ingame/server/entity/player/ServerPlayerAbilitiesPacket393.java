...
public class ServerPlayerAbilitiesPacket393 extends MinecraftPacket implements ServerPlayerAbilitiesPacket {
    ...
    private ServerPlayerAbilitiesPacket393() {
    }

    public ServerPlayerAbilitiesPacket393(boolean invincible, boolean canFly, boolean flying, boolean creative, float flySpeed, float walkSpeed) {
