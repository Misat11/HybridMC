...
@Getter
public class ServerOpenWindowPacket401 extends MinecraftPacket implements ServerOpenWindowPacket {
    ...
    private ServerOpenWindowPacket401() {
    }

    public ServerOpenWindowPacket401(int windowId, WindowType type, String name, int slots) {
        this(windowId, type, name, slots, 0);
    }

    public ServerOpenWindowPacket401(int windowId, WindowType type, String name, int slots, int ownerEntityId) {
