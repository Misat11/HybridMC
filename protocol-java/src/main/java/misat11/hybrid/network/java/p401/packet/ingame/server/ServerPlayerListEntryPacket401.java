...
@Getter
public class ServerPlayerListEntryPacket401 extends MinecraftPacket implements ServerPlayerListEntryPacket {
    private PlayerListEntryAction action;
    private PlayerListEntry entries[];

    @SuppressWarnings("unused")
    private ServerPlayerListEntryPacket401() {
    }

    public ServerPlayerListEntryPacket401(PlayerListEntryAction action, PlayerListEntry entries[]) {
        this.action = action;
