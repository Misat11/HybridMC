...
public class ServerPlayerAbilitiesPacket401 extends MinecraftPacket implements ServerPlayerAbilitiesPacket {
    ...
    private ServerPlayerAbilitiesPacket401() {
    }

    public ServerPlayerAbilitiesPacket401(boolean invincible, boolean canFly, boolean flying, boolean creative, float flySpeed, float walkSpeed) {
