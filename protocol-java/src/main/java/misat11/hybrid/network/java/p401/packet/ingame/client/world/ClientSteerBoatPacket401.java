...
@Getter
public class ClientSteerBoatPacket401 extends MinecraftPacket implements ClientSteerBoatPacket {
    private boolean rightPaddleTurning;
    private boolean leftPaddleTurning;

    @SuppressWarnings("unused")
    private ClientSteerBoatPacket401() {
    }

    public ClientSteerBoatPacket401(boolean rightPaddleTurning, boolean leftPaddleTurning) {
