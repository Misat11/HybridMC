...
@Getter
public class ServerDeclareTagsPacket401 extends MinecraftPacket implements ServerDeclareTagsPacket {
    private Map<String, int[]> blockTags;
    private Map<String, int[]> itemTags;
    private Map<String, int[]> fluidTags;

    @SuppressWarnings("unused")
    private ServerDeclareTagsPacket401() {
    }

    public ServerDeclareTagsPacket401(Map<String, int[]> blockTags, Map<String, int[]> itemTags, Map<String, int[]> fluidTags) {
