...
@Getter
public class ServerTitlePacket401 extends MinecraftPacket implements ServerTitlePacket {
    ...
    private ServerTitlePacket401() {
    }

    public ServerTitlePacket401(String title, boolean sub) {
        this(Message.fromString(title), sub);
    }

    public ServerTitlePacket401(Message title, boolean sub) {
        this(sub ? TitleAction.SUBTITLE : TitleAction.TITLE, title);
    }

    public ServerTitlePacket401(TitleAction action, String title) {
        this(action, Message.fromString(title));
    }

    public ServerTitlePacket401(TitleAction action, Message title) {
        this.action = action;
    ...
    public ServerTitlePacket401(int fadeIn, int stay, int fadeOut) {
    ...
    public ServerTitlePacket401(boolean clear) {
        if(clear) {
