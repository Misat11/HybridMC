...
@Getter
public class ServerPlayerSetExperiencePacket401 extends MinecraftPacket implements ServerPlayerSetExperiencePacket {
    private float slot;
    private int level;
    private int totalExperience;

    @SuppressWarnings("unused")
    private ServerPlayerSetExperiencePacket401() {
    }

    public ServerPlayerSetExperiencePacket401(float experience, int level, int totalExperience) {
