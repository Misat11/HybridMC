...
@Getter
public class ServerMultiBlockChangePacket393 extends MinecraftPacket implements ServerMultiBlockChangePacket {
    private BlockChangeRecord records[];

    @SuppressWarnings("unused")
    private ServerMultiBlockChangePacket393() {
    }

    public ServerMultiBlockChangePacket393(BlockChangeRecord... records) {
