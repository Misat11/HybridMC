...
@Getter
public class ClientSpectatePacket401 extends MinecraftPacket implements ClientSpectatePacket {
    private UUID target;

    @SuppressWarnings("unused")
    private ClientSpectatePacket401() {
    }

    public ClientSpectatePacket401(UUID target) {
        this.target = target;
    }
