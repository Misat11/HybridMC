...
@Getter
public class ServerSpawnMobPacket404 extends MinecraftPacket implements ServerSpawnMobPacket {
    ...
    private ServerSpawnMobPacket404() {
    }

    public ServerSpawnMobPacket404(int entityId, UUID uuid, MobType type, double x, double y, double z, float yaw, float pitch, float headYaw, double motX, double motY, double motZ, EntityMetadata metadata[]) {
