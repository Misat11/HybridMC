...
@Getter
public class ServerDeclareCommandsPacket401 extends MinecraftPacket implements ServerDeclareCommandsPacket {
    private byte[] data;

    @SuppressWarnings("unused")
    private ServerDeclareCommandsPacket401() {
    }

    @Deprecated // This packet isn't fully implemented, please send a PR if you need to use it
    public ServerDeclareCommandsPacket401(byte[] data) {
        this.data = data;
    }
