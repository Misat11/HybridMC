...
@Getter
public class ServerStopSoundPacket401 extends MinecraftPacket implements ServerStopSoundPacket {
    private SoundCategory category;
    private Sound sound;

    @SuppressWarnings("unused")
    private ServerStopSoundPacket401() {
    }

    public ServerStopSoundPacket401(SoundCategory category, Sound sound) {
