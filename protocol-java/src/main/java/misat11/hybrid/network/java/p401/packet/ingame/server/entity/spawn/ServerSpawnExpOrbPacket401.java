...
@Getter
public class ServerSpawnExpOrbPacket401 extends MinecraftPacket implements ServerSpawnExpOrbPacket {
    ...
    private ServerSpawnExpOrbPacket401() {
    }

    public ServerSpawnExpOrbPacket401(int entityId, double x, double y, double z, int exp) {
