...
@Getter
public class EncryptionRequestPacket404 extends MinecraftPacket implements EncryptionRequestPacket {
    private String serverId;
    private PublicKey publicKey;
    private byte verifyToken[];

    @SuppressWarnings("unused")
    private EncryptionRequestPacket404() {
    }

    public EncryptionRequestPacket404(String serverId, PublicKey publicKey, byte verifyToken[]) {
