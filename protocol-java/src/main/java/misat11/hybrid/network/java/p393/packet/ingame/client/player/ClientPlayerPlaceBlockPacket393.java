...
@Getter 
public class ClientPlayerPlaceBlockPacket393 extends MinecraftPacket implements ClientPlayerPlaceBlockPacket {
    ...
    private ClientPlayerPlaceBlockPacket393() {
    }

    public ClientPlayerPlaceBlockPacket393(Position position, BlockFace face, Hand hand, float cursorX, float cursorY, float cursorZ) {
