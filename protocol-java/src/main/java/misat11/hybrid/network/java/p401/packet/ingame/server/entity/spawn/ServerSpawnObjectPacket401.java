...
@Getter
public class ServerSpawnObjectPacket401 extends MinecraftPacket implements ServerSpawnObjectPacket {
    ...
    private ServerSpawnObjectPacket401() {
    }

    public ServerSpawnObjectPacket401(int entityId, UUID uuid, ObjectType type, double x, double y, double z, float yaw, float pitch) {
        this(entityId, uuid, type, null, x, y, z, yaw, pitch, 0, 0, 0);
    }

    public ServerSpawnObjectPacket401(int entityId, UUID uuid, ObjectType type, ObjectData data, double x, double y, double z, float yaw, float pitch) {
        this(entityId, uuid, type, data, x, y, z, yaw, pitch, 0, 0, 0);
    }

    public ServerSpawnObjectPacket401(int entityId, UUID uuid, ObjectType type, double x, double y, double z, float yaw, float pitch, double motX, double motY, double motZ) {
        this(entityId, uuid, type, new ObjectData() {
        }, x, y, z, yaw, pitch, motX, motY, motZ);
    }

    public ServerSpawnObjectPacket401(int entityId, UUID uuid, ObjectType type, ObjectData data, double x, double y, double z, float yaw, float pitch, double motX, double motY, double motZ) {
