...
public class ClientAdvancementTabPacket404 extends MinecraftPacket implements ClientAdvancementTabPacket {
    private AdvancementTabAction action;
    private String tabId;

    public ClientAdvancementTabPacket404() {
        this.action = AdvancementTabAction.CLOSED_SCREEN;
    }

    public ClientAdvancementTabPacket404(String tabId) {
