...
@Getter
public class ClientPlayerAbilitiesPacket404 extends MinecraftPacket implements ClientPlayerAbilitiesPacket {
    ...
    private ClientPlayerAbilitiesPacket404() {
    }

    public ClientPlayerAbilitiesPacket404(boolean invincible, boolean canFly, boolean flying, boolean creative, float flySpeed, float walkSpeed) {
