...
@Getter
public class ServerEntityMovementPacket401 extends MinecraftPacket implements ServerEntityMovementPacket {
    ...
    protected ServerEntityMovementPacket401() {
    }

    public ServerEntityMovementPacket401(int entityId, boolean onGround) {
