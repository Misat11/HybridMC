...
@Getter
public class ServerDeclareTagsPacket404 extends MinecraftPacket implements ServerDeclareTagsPacket {
    private Map<String, int[]> blockTags;
    private Map<String, int[]> itemTags;
    private Map<String, int[]> fluidTags;

    @SuppressWarnings("unused")
    private ServerDeclareTagsPacket404() {
    }

    public ServerDeclareTagsPacket404(Map<String, int[]> blockTags, Map<String, int[]> itemTags, Map<String, int[]> fluidTags) {
