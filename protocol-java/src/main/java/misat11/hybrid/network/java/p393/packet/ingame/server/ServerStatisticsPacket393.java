...
@Getter
public class ServerStatisticsPacket393 extends MinecraftPacket implements ServerStatisticsPacket {
    private Map<Statistic, Integer> statistics = new HashMap<Statistic, Integer>();

    @SuppressWarnings("unused")
    private ServerStatisticsPacket393() {
    }

    public ServerStatisticsPacket393(Map<Statistic, Integer> statistics) {
