...
@Getter
public class ServerPlayerFacingPacket401 extends MinecraftPacket implements ServerPlayerFacingPacket {
    ...
    private ServerPlayerFacingPacket401() {
    }

    public ServerPlayerFacingPacket401(FeetOrEyes origin, double x, double y, double z) {
        this.origin = origin;
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public ServerPlayerFacingPacket401(FeetOrEyes origin, int targetEntityId, FeetOrEyes lookAt) {
        this.origin = origin;
