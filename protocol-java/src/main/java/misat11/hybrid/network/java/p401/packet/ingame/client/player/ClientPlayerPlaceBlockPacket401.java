...
@Getter 
public class ClientPlayerPlaceBlockPacket401 extends MinecraftPacket implements ClientPlayerPlaceBlockPacket {
    ...
    private ClientPlayerPlaceBlockPacket401() {
    }

    public ClientPlayerPlaceBlockPacket401(Position position, BlockFace face, Hand hand, float cursorX, float cursorY, float cursorZ) {
