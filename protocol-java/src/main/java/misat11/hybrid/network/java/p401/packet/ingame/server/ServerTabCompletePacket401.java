...
@Getter
public class ServerTabCompletePacket401 extends MinecraftPacket implements ServerTabCompletePacket {
    ...
    private ServerTabCompletePacket401() {
    }

    public ServerTabCompletePacket401(int transactionId, int start, int length, String matches[], Message tooltips[]) {
