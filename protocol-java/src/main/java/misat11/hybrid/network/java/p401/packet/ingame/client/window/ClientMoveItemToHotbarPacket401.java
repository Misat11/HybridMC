...
@Getter
public class ClientMoveItemToHotbarPacket401 extends MinecraftPacket implements ClientMoveItemToHotbarPacket {
    private int slot;

    @SuppressWarnings("unused")
    private ClientMoveItemToHotbarPacket401() {
    }

    public ClientMoveItemToHotbarPacket401(int slot) {
        this.slot = slot;
    }
