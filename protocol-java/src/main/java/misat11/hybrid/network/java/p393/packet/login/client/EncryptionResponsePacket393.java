...
public class EncryptionResponsePacket393 extends MinecraftPacket implements EncryptionResponsePacket {
    private byte sharedKey[];
    private byte verifyToken[];

    @SuppressWarnings("unused")
    private EncryptionResponsePacket393() {
    }

    public EncryptionResponsePacket393(SecretKey secretKey, PublicKey publicKey, byte verifyToken[]) {
