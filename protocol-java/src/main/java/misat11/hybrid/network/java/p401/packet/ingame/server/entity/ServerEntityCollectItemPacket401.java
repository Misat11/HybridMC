...
@Getter
public class ServerEntityCollectItemPacket401 extends MinecraftPacket implements ServerEntityCollectItemPacket {
    private int collectedEntityId;
    private int collectorEntityId;
    private int itemCount;

    @SuppressWarnings("unused")
    private ServerEntityCollectItemPacket401() {
    }

    public ServerEntityCollectItemPacket401(int collectedEntityId, int collectorEntityId, int itemCount) {
