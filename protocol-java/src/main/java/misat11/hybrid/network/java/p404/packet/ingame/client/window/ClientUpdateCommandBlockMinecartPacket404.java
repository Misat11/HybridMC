...
@Getter
public class ClientUpdateCommandBlockMinecartPacket404 extends MinecraftPacket implements ClientUpdateCommandBlockMinecartPacket {
    private int entityId;
    private String command;
    private boolean doesTrackOutput;

    @SuppressWarnings("unused")
    private ClientUpdateCommandBlockMinecartPacket404() {
    }

    public ClientUpdateCommandBlockMinecartPacket404(int entityId, String command, boolean doesTrackOutput) {
