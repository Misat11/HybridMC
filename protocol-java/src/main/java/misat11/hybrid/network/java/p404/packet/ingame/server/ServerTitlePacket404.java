...
@Getter
public class ServerTitlePacket404 extends MinecraftPacket implements ServerTitlePacket {
    ...
    private ServerTitlePacket404() {
    }

    public ServerTitlePacket404(String title, boolean sub) {
        this(Message.fromString(title), sub);
    }

    public ServerTitlePacket404(Message title, boolean sub) {
        this(sub ? TitleAction.SUBTITLE : TitleAction.TITLE, title);
    }

    public ServerTitlePacket404(TitleAction action, String title) {
        this(action, Message.fromString(title));
    }

    public ServerTitlePacket404(TitleAction action, Message title) {
        this.action = action;
    ...
    public ServerTitlePacket404(int fadeIn, int stay, int fadeOut) {
    ...
    public ServerTitlePacket404(boolean clear) {
        if(clear) {
