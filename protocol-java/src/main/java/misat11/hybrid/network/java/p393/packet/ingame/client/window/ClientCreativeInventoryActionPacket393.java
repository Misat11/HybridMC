...
@Getter
public class ClientCreativeInventoryActionPacket393 extends MinecraftPacket implements ClientCreativeInventoryActionPacket {
    private int slot;
    private ItemStack clickedItem;

    @SuppressWarnings("unused")
    private ClientCreativeInventoryActionPacket393() {
    }

    public ClientCreativeInventoryActionPacket393(int slot, ItemStack clickedItem) {
        this.slot = slot;
