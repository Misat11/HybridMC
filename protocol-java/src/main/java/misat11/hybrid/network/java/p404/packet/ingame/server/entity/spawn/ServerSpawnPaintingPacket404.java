...
@Getter
public class ServerSpawnPaintingPacket404 extends MinecraftPacket implements ServerSpawnPaintingPacket {
    ...
    private ServerSpawnPaintingPacket404() {
    }

    public ServerSpawnPaintingPacket404(int entityId, UUID uuid, PaintingType paintingType, Position position, HangingDirection direction) {
