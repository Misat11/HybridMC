...
@Getter
public class ClientTabCompletePacket404 extends MinecraftPacket implements ClientTabCompletePacket {
    private int transactionId;
    private String text;

    @SuppressWarnings("unused")
    private ClientTabCompletePacket404() {
    }

    public ClientTabCompletePacket404(int transactionId, String text) {
