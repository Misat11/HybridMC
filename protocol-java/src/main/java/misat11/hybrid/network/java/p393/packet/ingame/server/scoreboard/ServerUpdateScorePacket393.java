...
@Getter
public class ServerUpdateScorePacket393 extends MinecraftPacket implements ServerUpdateScorePacket {
    ...
    private ServerUpdateScorePacket393() {
    }

    public ServerUpdateScorePacket393(String entry, String objective) {
        this.entry = entry;
        this.objective = objective;
        this.action = ScoreboardAction.REMOVE;
    }

    public ServerUpdateScorePacket393(String entry, String objective, int value) {
        this.entry = entry;
        this.objective = objective;
        this.value = value;
