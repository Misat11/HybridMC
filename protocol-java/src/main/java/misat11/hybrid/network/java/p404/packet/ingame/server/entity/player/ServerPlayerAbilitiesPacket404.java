...
public class ServerPlayerAbilitiesPacket404 extends MinecraftPacket implements ServerPlayerAbilitiesPacket {
    ...
    private ServerPlayerAbilitiesPacket404() {
    }

    public ServerPlayerAbilitiesPacket404(boolean invincible, boolean canFly, boolean flying, boolean creative, float flySpeed, float walkSpeed) {
