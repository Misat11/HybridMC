...
@Getter
public class ClientTabCompletePacket393 extends MinecraftPacket implements ClientTabCompletePacket {
    private int transactionId;
    private String text;

    @SuppressWarnings("unused")
    private ClientTabCompletePacket393() {
    }

    public ClientTabCompletePacket393(int transactionId, String text) {
