...
@Getter
public class ServerMapDataPacket401 extends MinecraftPacket implements ServerMapDataPacket {
    private int mapId;
    private byte scale;
    ...
    private ServerMapDataPacket401() {
    }

    public ServerMapDataPacket401(int mapId, byte scale, boolean trackingPosition, MapIcon icons[]) {
        this(mapId, scale, trackingPosition, icons, null);
    }

    public ServerMapDataPacket401(int mapId, byte scale, boolean trackingPosition, MapIcon icons[], MapData data) {
        this.mapId = mapId;
        this.scale = scale;
