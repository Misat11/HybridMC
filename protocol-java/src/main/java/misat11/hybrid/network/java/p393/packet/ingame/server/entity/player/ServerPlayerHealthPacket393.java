...
@Getter
public class ServerPlayerHealthPacket393 extends MinecraftPacket implements ServerPlayerHealthPacket {
    private float health;
    private int food;
    private float saturation;

    @SuppressWarnings("unused")
    private ServerPlayerHealthPacket393() {
    }

    public ServerPlayerHealthPacket393(float health, int food, float saturation) {
        this.health = health;
        this.food = food;
