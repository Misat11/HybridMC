...
@Getter
public class ClientPlayerInteractEntityPacket393 extends MinecraftPacket implements ClientPlayerInteractEntityPacket{
    ...
    private ClientPlayerInteractEntityPacket393() {
    }

    public ClientPlayerInteractEntityPacket393(int entityId, InteractAction action) {
        this(entityId, action, Hand.MAIN_HAND);
    }

    public ClientPlayerInteractEntityPacket393(int entityId, InteractAction action, Hand hand) {
        this(entityId, action, 0, 0, 0, hand);
    }

    public ClientPlayerInteractEntityPacket393(int entityId, InteractAction action, float targetX, float targetY, float targetZ, Hand hand) {
