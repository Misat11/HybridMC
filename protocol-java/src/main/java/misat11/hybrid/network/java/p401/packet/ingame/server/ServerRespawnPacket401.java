...
@Getter
public class ServerRespawnPacket401 extends MinecraftPacket implements ServerRespawnPacket {
    ...
    private ServerRespawnPacket401() {
    }

    public ServerRespawnPacket401(int dimension, Difficulty difficulty, GameMode gameMode, WorldType worldType) {
