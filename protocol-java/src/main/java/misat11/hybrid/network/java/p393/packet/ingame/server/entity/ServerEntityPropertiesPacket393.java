...
@Getter
public class ServerEntityPropertiesPacket393 extends MinecraftPacket implements ServerEntityPropertiesPacket {
    private int entityId;
    private List<Attribute> attributes;

    @SuppressWarnings("unused")
    private ServerEntityPropertiesPacket393() {
    }

    public ServerEntityPropertiesPacket393(int entityId, List<Attribute> attributes) {
