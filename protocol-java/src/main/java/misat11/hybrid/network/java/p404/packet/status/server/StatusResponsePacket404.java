...
@Getter
public class StatusResponsePacket404 extends MinecraftPacket implements StatusResponsePacket {
    private ServerStatusInfo info;

    @SuppressWarnings("unused")
    private StatusResponsePacket404() {
    }

    public StatusResponsePacket404(ServerStatusInfo info) {
        this.info = info;
    }
