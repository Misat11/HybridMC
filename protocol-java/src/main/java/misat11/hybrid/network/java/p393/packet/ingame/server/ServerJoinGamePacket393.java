...
@Getter
public class ServerJoinGamePacket393 extends MinecraftPacket implements ServerJoinGamePacket {
    ...
    private ServerJoinGamePacket393() {
    }

    public ServerJoinGamePacket393(int entityId, boolean hardcore, GameMode gameMode, int dimension, Difficulty difficulty, int maxPlayers, WorldType worldType, boolean reducedDebugInfo) {
