...
@Getter
public class ServerEntityVelocityPacket401 extends MinecraftPacket implements ServerEntityVelocityPacket {
    ...
    private ServerEntityVelocityPacket401() {
    }

    public ServerEntityVelocityPacket401(int entityId, double motX, double motY, double motZ) {
