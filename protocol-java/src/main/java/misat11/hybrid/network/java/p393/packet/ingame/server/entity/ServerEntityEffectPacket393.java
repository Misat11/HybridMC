...
@Getter
public class ServerEntityEffectPacket393 extends MinecraftPacket implements ServerEntityEffectPacket {
    ...
    private ServerEntityEffectPacket393() {
    }

    public ServerEntityEffectPacket393(int entityId, Effect effect, int amplifier, int duration, boolean ambient, boolean showParticles) {
