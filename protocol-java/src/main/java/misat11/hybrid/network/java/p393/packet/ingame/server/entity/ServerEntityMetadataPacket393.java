...
@Getter
public class ServerEntityMetadataPacket393 extends MinecraftPacket implements ServerEntityMetadataPacket {
    private int entityId;
    private EntityMetadata metadata[];

    @SuppressWarnings("unused")
    private ServerEntityMetadataPacket393() {
    }

    public ServerEntityMetadataPacket393(int entityId, EntityMetadata metadata[]) {
