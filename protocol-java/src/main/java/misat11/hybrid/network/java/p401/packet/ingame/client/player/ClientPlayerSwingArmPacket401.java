...
@Getter
public class ClientPlayerSwingArmPacket401 extends MinecraftPacket implements ClientPlayerSwingArmPacket {
    private Hand hand;

    @SuppressWarnings("unused")
    private ClientPlayerSwingArmPacket401() {
    }

    public ClientPlayerSwingArmPacket401(Hand hand) {
        this.hand = hand;
    }
