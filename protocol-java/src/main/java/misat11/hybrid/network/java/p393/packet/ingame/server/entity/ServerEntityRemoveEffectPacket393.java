...
@Getter
public class ServerEntityRemoveEffectPacket393 extends MinecraftPacket implements ServerEntityRemoveEffectPacket {
    private int entityId;
    private Effect effect;

    @SuppressWarnings("unused")
    private ServerEntityRemoveEffectPacket393() {
    }

    public ServerEntityRemoveEffectPacket393(int entityId, Effect effect) {
