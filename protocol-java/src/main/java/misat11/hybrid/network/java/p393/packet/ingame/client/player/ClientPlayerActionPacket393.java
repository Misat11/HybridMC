...
@Getter
public class ClientPlayerActionPacket393 extends MinecraftPacket implements ClientPlayerActionPacket {
    private PlayerAction action;
    private Position position;
    private BlockFace face;

    @SuppressWarnings("unused")
    private ClientPlayerActionPacket393() {
    }

    public ClientPlayerActionPacket393(PlayerAction action, Position position, BlockFace face) {
        this.action = action;
