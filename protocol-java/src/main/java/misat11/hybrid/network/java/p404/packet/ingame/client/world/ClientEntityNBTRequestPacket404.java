...
@Getter
public class ClientEntityNBTRequestPacket404 extends MinecraftPacket implements ClientEntityNBTRequestPacket{
    private int transactionId;
    private int entityId;

    @SuppressWarnings("unused")
    private ClientEntityNBTRequestPacket404() {
    }

    public ClientEntityNBTRequestPacket404(int transactionId, int entityId) {
