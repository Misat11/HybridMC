...
@Getter
public class ServerSpawnPlayerPacket404 extends MinecraftPacket implements ServerSpawnPlayerPacket {
    ...
    private ServerSpawnPlayerPacket404() {
    }

    public ServerSpawnPlayerPacket404(int entityId, UUID uuid, double x, double y, double z, float yaw, float pitch, EntityMetadata metadata[]) {
