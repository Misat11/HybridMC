...
@Getter
public class LoginSuccessPacket404 extends MinecraftPacket implements LoginSuccessPacket {
    private GameProfile profile;

    @SuppressWarnings("unused")
    private LoginSuccessPacket404() {
    }

    public LoginSuccessPacket404(GameProfile profile) {
