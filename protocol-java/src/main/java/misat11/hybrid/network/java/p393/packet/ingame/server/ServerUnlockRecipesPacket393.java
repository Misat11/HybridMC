...
@Getter
public class ServerUnlockRecipesPacket393 extends MinecraftPacket implements ServerUnlockRecipesPacket {
    ...
    private ServerUnlockRecipesPacket393() {
    }

    private ServerUnlockRecipesPacket393(boolean openCraftingBook, boolean activateCraftingFiltering,
    ...
    public ServerUnlockRecipesPacket393(boolean openCraftingBook, boolean activateCraftingFiltering,
                                     boolean openSmeltingBook, boolean activateSmeltingFiltering,
