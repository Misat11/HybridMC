...
@Getter
public class ServerCombatPacket393 extends MinecraftPacket implements ServerCombatPacket {
    ...
    public ServerCombatPacket393() {
        this.combatState = CombatState.ENTER_COMBAT;
    }

    public ServerCombatPacket393(int entityId, int duration) {
        this.combatState = CombatState.END_COMBAT;
        this.entityId = entityId;
        this.duration = duration;
    }

    public ServerCombatPacket393(int entityId, int playerId, Message message) {
