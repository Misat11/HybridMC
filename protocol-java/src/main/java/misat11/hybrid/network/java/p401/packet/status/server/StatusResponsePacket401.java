...
import misat11.hybrid.network.java.pabstract.data.status.PlayerInfo;
import misat11.hybrid.network.java.pabstract.data.status.ServerStatusInfo;
import misat11.hybrid.network.java.pabstract.data.status.VersionInfo;
...
@Getter
public class StatusResponsePacket401 extends MinecraftPacket implements StatusResponsePacket {
    private ServerStatusInfo info;

    @SuppressWarnings("unused")
    private StatusResponsePacket401() {
    }

    public StatusResponsePacket401(ServerStatusInfo info) {
        this.info = info;
    }
