...
@Getter
public class ServerCombatPacket401 extends MinecraftPacket implements ServerCombatPacket {
    ...
    public ServerCombatPacket401() {
        this.combatState = CombatState.ENTER_COMBAT;
    }

    public ServerCombatPacket401(int entityId, int duration) {
        this.combatState = CombatState.END_COMBAT;
        this.entityId = entityId;
        this.duration = duration;
    }

    public ServerCombatPacket401(int entityId, int playerId, Message message) {
