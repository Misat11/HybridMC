...
@Getter
public class ServerEntitySetPassengersPacket393 extends MinecraftPacket implements ServerEntitySetPassengersPacket {
    private int entityId;
    private int passengerIds[];

    @SuppressWarnings("unused")
    private ServerEntitySetPassengersPacket393() {
    }

    public ServerEntitySetPassengersPacket393(int entityId, int... passengerIds) {
