...
@Getter
public class ClientPlayerUseItemPacket401 extends MinecraftPacket implements ClientPlayerUseItemPacket {
    private Hand hand;

    @SuppressWarnings("unused")
    private ClientPlayerUseItemPacket401() {
    }

    public ClientPlayerUseItemPacket401(Hand hand) {
        this.hand = hand;
    }
