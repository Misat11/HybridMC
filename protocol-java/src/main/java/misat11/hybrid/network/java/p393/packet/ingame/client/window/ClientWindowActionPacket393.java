...
@Getter
public class ClientWindowActionPacket393 extends MinecraftPacket implements ClientWindowActionPacket {
    ...
    private ClientWindowActionPacket393() {
    }

    public ClientWindowActionPacket393(int windowId, int actionId, int slot, ItemStack clickedItem, WindowAction action, WindowActionParam param) {
