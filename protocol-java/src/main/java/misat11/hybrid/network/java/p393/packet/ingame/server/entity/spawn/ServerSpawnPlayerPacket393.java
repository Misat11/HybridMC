...
@Getter
public class ServerSpawnPlayerPacket393 extends MinecraftPacket implements ServerSpawnPlayerPacket {
    ...
    private ServerSpawnPlayerPacket393() {
    }

    public ServerSpawnPlayerPacket393(int entityId, UUID uuid, double x, double y, double z, float yaw, float pitch, EntityMetadata metadata[]) {
