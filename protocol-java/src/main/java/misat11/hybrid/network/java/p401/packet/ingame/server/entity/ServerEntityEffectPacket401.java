...
@Getter
public class ServerEntityEffectPacket401 extends MinecraftPacket implements ServerEntityEffectPacket {
    ...
    private ServerEntityEffectPacket401() {
    }

    public ServerEntityEffectPacket401(int entityId, Effect effect, int amplifier, int duration, boolean ambient, boolean showParticles) {
