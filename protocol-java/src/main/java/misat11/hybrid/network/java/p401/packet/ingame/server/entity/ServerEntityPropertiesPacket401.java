...
@Getter
public class ServerEntityPropertiesPacket401 extends MinecraftPacket implements ServerEntityPropertiesPacket {
    private int entityId;
    private List<Attribute> attributes;

    @SuppressWarnings("unused")
    private ServerEntityPropertiesPacket401() {
    }

    public ServerEntityPropertiesPacket401(int entityId, List<Attribute> attributes) {
