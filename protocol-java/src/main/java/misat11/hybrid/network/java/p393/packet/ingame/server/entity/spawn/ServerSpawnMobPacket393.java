...
@Getter
public class ServerSpawnMobPacket393 extends MinecraftPacket implements ServerSpawnMobPacket {
    ...
    private ServerSpawnMobPacket393() {
    }

    public ServerSpawnMobPacket393(int entityId, UUID uuid, MobType type, double x, double y, double z, float yaw, float pitch, float headYaw, double motX, double motY, double motZ, EntityMetadata metadata[]) {
