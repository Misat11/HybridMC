...
@Getter
public class ServerPlayEffectPacket404 extends MinecraftPacket implements ServerPlayEffectPacket {
    ...
    private ServerPlayEffectPacket404() {
    }

    public ServerPlayEffectPacket404(WorldEffect effect, Position position, WorldEffectData data) {
        this(effect, position, data, false);
    }

    public ServerPlayEffectPacket404(WorldEffect effect, Position position, WorldEffectData data, boolean broadcast) {
        this.effect = effect;
