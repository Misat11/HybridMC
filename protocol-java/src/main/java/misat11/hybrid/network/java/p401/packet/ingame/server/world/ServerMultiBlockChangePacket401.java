...
@Getter
public class ServerMultiBlockChangePacket401 extends MinecraftPacket implements ServerMultiBlockChangePacket {
    private BlockChangeRecord records[];

    @SuppressWarnings("unused")
    private ServerMultiBlockChangePacket401() {
    }

    public ServerMultiBlockChangePacket401(BlockChangeRecord... records) {
