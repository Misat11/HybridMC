...
import misat11.hybrid.network.java.p404.data.status.PlayerInfo;
import misat11.hybrid.network.java.p404.data.status.ServerStatusInfo;
import misat11.hybrid.network.java.p404.data.status.VersionInfo;
import misat11.hybrid.network.java.p404.data.status.handler.ServerInfoBuilder;
...
public class ServerListener extends SessionAdapter {
    ...
    private class UserAuthTask implements Runnable {
        ...
        public void run() {
            ...
            ((MinecraftProtocol404) this.session.getPacketProtocol()).setSubProtocol(SubProtocol.GAME, false, this.session);
