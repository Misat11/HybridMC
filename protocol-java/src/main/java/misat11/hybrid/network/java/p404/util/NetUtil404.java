...
public class NetUtil404 {
    ...
    public static Particle readParticle(NetInput in) throws IOException {
        ParticleType type = MagicValues404.key(ParticleType.class, in.readVarInt());
    ...
    public static void writeParticle(NetOutput out, Particle particle) throws IOException {
        out.writeVarInt(MagicValues404.value(Integer.class, particle.getType()));
    ...
    public static EntityMetadata[] readEntityMetadata(NetInput in) throws IOException {
        ...
        while((id = in.readUnsignedByte()) != 255) {
            ...
            MetadataType type = MagicValues404.key(MetadataType.class, typeId);
            Object value = null;
            switch(type) {
                case BYTE:
                    value = in.readByte();
                ...
                case OPTIONAL_POSITION:
                    ...
                    break;
                case BLOCK_FACE:
                    value = MagicValues404.key(BlockFace.class, in.readVarInt());
                    break;
                case OPTIONAL_UUID:
    ...
    public static void writeEntityMetadata(NetOutput out, EntityMetadata[] metadata) throws IOException {
        for(EntityMetadata meta : metadata) {
            ...
            out.writeVarInt(MagicValues404.value(Integer.class, meta.getType()));
            switch(meta.getType()) {
                case BYTE:
                ...
                case OPTIONAL_POSITION:
                    ...
                    break;
                case BLOCK_FACE:
                    out.writeVarInt(MagicValues404.value(Integer.class, (BlockFace) meta.getValue()));
                    break;
                case OPTIONAL_UUID:
                    out.writeBoolean(meta.getValue() != null);
                    if(meta.getValue() != null) {
