...
@Getter
public class ClientSteerVehiclePacket404 extends MinecraftPacket implements ClientSteerVehiclePacket {
    ...
    private ClientSteerVehiclePacket404() {
    }

    public ClientSteerVehiclePacket404(float sideways, float forward, boolean jump, boolean dismount) {
