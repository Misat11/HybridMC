...
@Getter
public class ClientRequestPacket393 extends MinecraftPacket implements ClientRequestPacket {
    private ClientRequest request;

    @SuppressWarnings("unused")
    private ClientRequestPacket393() {
    }

    public ClientRequestPacket393(ClientRequest request) {
