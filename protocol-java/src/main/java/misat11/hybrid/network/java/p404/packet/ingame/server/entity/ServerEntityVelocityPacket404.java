...
@Getter
public class ServerEntityVelocityPacket404 extends MinecraftPacket implements ServerEntityVelocityPacket {
    ...
    private ServerEntityVelocityPacket404() {
    }

    public ServerEntityVelocityPacket404(int entityId, double motX, double motY, double motZ) {
