...
@Getter
public class ServerStopSoundPacket393 extends MinecraftPacket implements ServerStopSoundPacket {
    private SoundCategory category;
    private Sound sound;

    @SuppressWarnings("unused")
    private ServerStopSoundPacket393() {
    }

    public ServerStopSoundPacket393(SoundCategory category, Sound sound) {
