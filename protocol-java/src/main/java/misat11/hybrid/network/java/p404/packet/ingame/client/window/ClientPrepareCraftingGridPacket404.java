...
@Getter
public class ClientPrepareCraftingGridPacket404 extends MinecraftPacket implements ClientPrepareCraftingGridPacket {
    private int windowId;
    private String recipeId;
    private boolean makeAll;

    @SuppressWarnings("unused")
    private ClientPrepareCraftingGridPacket404() {
    }

    public ClientPrepareCraftingGridPacket404(int windowId, String recipeId, boolean makeAll) {
