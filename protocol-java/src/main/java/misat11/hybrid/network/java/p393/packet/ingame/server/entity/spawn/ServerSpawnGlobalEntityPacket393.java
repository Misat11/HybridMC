...
@Getter
public class ServerSpawnGlobalEntityPacket393 extends MinecraftPacket implements ServerSpawnGlobalEntityPacket {
    ...
    private ServerSpawnGlobalEntityPacket393() {
    }

    public ServerSpawnGlobalEntityPacket393(int entityId, GlobalEntityType type, double x, double y, double z) {
